  ...
  return (
    <motion.div className="fixed top-0 bottom-0 left-0 right-0 z-50 flex p-4 sm:p-12 backdrop-blur-xl backdrop-brightness-75 ">
      ...
      >
        ...
        <div className="relative z-20 flex flex-col h-full col-span-4 gap-2 px-3 py-8 overflow-hidden lg:row-span-1 md:px-5 xl:px-12">
          <FromLeft
            delay={0.4}
            duration={1.2}
          ...
          <div className="flex flex-col h-full gap-12 px-2 py-4 overflow-y-auto grow md:px-4 ">
            <div className="flex flex-col gap-3 ">
              {descriptions.map((description, i) => (
                <FromLeft delay={0.7 + i * 0.5} duration={1.1}>
                  <h3 className="text-lg font-semibold leading-tight tracking-wider md:text-xl xl:text-3xl opacity-90 text-neutral-content">
                    {description.title}
                  </h3>
