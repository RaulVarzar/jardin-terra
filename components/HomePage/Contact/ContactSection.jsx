  ...
  return (
    ...
    >
      <motion.div
        ref={containerRef}
        style={{ y, scale }}
        className="flex items-center justify-center w-full min-h-[75vh] md:min-h-[85vh] px-2 md:px-4 lg:px-8 py-8 md:py-20 gap-y-10 gap-x-8 flex-col lg:grid-cols-2  md:gap-x-12 xl:gap-16 bg-secondary-content rounded-3xl md:rounded-4xl overflow-hidden "
      >
