            ...
            >
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="flex flex-col items-center justify-center w-full max-w-6xl gap-6 px-4 py-6 overflow-hidden border-2 border-opacity-0 xl:flex-row xl:py-12 sm:px-8 xl:px-12 bg-base-20 border-neutral-content h-fit rounded-2xl"
                >
                  <motion.div
                    style={{ opacity }}
                    layout="position"
