  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          layout
          className="flex flex-col items-center w-full gap-4 pb-2 mx-auto md:w-11/12  md:pb-6"
        >
          <i className="p-4 text-5xl md:text-5xl text-accent fa-solid fa-comments-dollar"></i>

          <motion.h5
            layout
            className=" w-11/12 text-base leading-none tracking-wide text-left text-pretty md:leading-snug md:text-lg lg:text-xl xl:text-2xl font-semibold  text-neutral-content opacity-80"
          >
