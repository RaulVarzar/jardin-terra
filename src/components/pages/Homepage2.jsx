...
const Homepage = () => {
  return (
    <div className="flex flex-row w-full h-screen text-2xl font-bold text-accent place-content-center">
      <div className="relative w-5/12 m-4 overflow-hidden shadow-2xl place-content-center rounded-4xl">
        <img
          src={banner}
      ...
      <div className="flex flex-col w-7/12 h-full gap-8 p-3">
        <Navbar />
