    ...
    >
      ...
      >
        <motion.span
          ...
          exit="exit"
          custom={id}
          className="flex items-center h-full leading-none text-neutral-content kanit opacity-95 active:scale-90 hover:opacity-100  tracking-wider text-3xl md:text-4xl lg:text-6xl"
        >
          {title}
        </motion.span>
      </motion.div>
