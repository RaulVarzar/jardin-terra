...
const ModalContent = () => {
  ...
  return (
    <motion.div className="relative flex h-fit flex-col justify-center items-center max-w-5xl gap-2 md:gap-8 px-8 py-10 md:py-16  md:px-6 bg-secondary rounded-3xl xl:rounded-5xl">
