...
const Contact = () => {
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-base-100 lg:flex-row">
      <Link to="/">
        <motion.button
          variants={{
      ...
      <div className="flex items-center bg-base-100 sticky top-0 h-fit justify-center lg:h-screen lg:justify-start lg:pl-20 2xl:pl-24 3xl:px-36 max-lg:min-h-[50vh] w-full lg:w-1/3 text-neutral-content">
        <ContactDetails />
      </div>
      <div
        ref={container}
        className="flex flex-col relative bg-base-200 items-start justify-center gap-4 px-16 text-4xl py-12 lg:w-2/3  max-lg:rounded-t-2xl lg:rounded-l-4xl text-neutral-content"
      >
