...
const ModalCard = ({ setSelectedId }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="relative z-50 flex flex-col max-w-5xl gap-8 px-2 pt-10 pb-8 md:pt-20 md:px-6 border-1 bg-base-200 border-neutral-content rounded-2xl border-opacity-10 w-fit h-fit"
        layoutId="toggle"
        layout
      >
        ...
        <div className="flex flex-col items-center w-full gap-4 pb-2 mx-auto md:w-11/12 md:items-start md:flex-row md:pb-6">
          <i className="p-4 text-6xl md:text-5xl text-accent fa-solid fa-comments-dollar"></i>
          <div className="flex flex-col gap-6 px-4">
            <motion.h5 className="leading-none tracking-wide text-left text-pretty md:leading-snug text-md md:text-lg 2xl:text-xl text-neutral-content opacity-90">
