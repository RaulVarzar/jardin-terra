...
const ToggleButton = ({ menuOpen, toggleMenu }) => {
  return (
    <MagneticButton>
      <div
        onClick={toggleMenu}
        className="relative max-sm:scale-[0.7] origin-right size-20 gap-3 md:px-4 py-4 md:py-8 cursor-pointer bg-secondary-content  hover:bg-opacity-65 rounded-full bg-opacity-0 transition-all duration-300"
      >
        <motion.span
          initial={{ scaleX: 0 }}
          animate={
