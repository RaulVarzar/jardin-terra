...
const PricingButton = ({ expanded, setExpanded }) => {
  ...
  return (
    <motion.div
      ...
      className="text-base-content origin-left w-fit my-4 bg-secondary shadow-sm transition-colors duration-300   overflow-hidden  rounded-full cursor-pointer group "
    >
      <motion.div
        animate={
          !expanded
