...
const Header = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center max-w-4xl gap-6 mx-auto mt-[15vh] pb-12 text-center px-6 2xl:max-w-5xl text-neutral-content"
    >
      ...
      <Reveal delay={0.5} duration={0.8}>
        <motion.p
          ...
          className="pt-2 text-sm font-light leading-snug tracking-wide opacity-50 xl:text-md"
        >
