    ...
    <div className="relative bg-primary-content z-10" id="home">
      ...
      >
        <div className="grid grid-rows-12 min-h-[80svh] 2xl:max-h-[85svh] borde xl:grid-cols-12 xl:grid-rows-1 w-full h-full justify-stretch gap-x-8 gap-y-4 ">
          <motion.div className="flex flex-col will-change-transform xl:items-start items-center w-full h-full  gap-2 row-span-6 sm:row-span-5 xl:col-span-6 max-xl:order-last justify-between   grow xl:gap-2 xl:py-4">
